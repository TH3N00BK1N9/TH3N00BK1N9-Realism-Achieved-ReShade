...
---------------------------------------------------------------
Before we begin:
I strongly recommend that you use this preset with games that does not max out your GPU since it may crash your game. IF you do want to use it, then turn some graphic settings down so avoid any issues. This may vary between devices, however.
---------------------------------------------------------------
How to install:
...
You may need to adjust display depth, there are many tutorials online, (when I have the time, I will provide one soon!)
**In the addons tab there should be a way to support DLSS, FSR, XeSS or any other upscaler.** 
----------------------------------------------------------------
FINAL NOTES:
...
5. THERE WILL BE SEE THROUGH MENUS SO TURN OFF THE EFFECTS IF YOU NEED TO USE IN GAME MENUS (THERE IS NO WORK AROUND FOR THIS!).
6. ALL SHADERS INCLUDED IN THIS PRESET ARE CREDITED TO THEIR RESPECTIVE CREATORS: JakobPCoder, AlucardDH, mj-ehsan, martymcmodding.
